...
def draw_final_outputs(img, results,objectfile):
    """
    Args:
    ...
    for r in results:
        ...
        objectfile.write(cfg.DATA.CLASS_NAMES[r.class_id])
        objectfile.write('\t')
        objectfile.write('-1')
        objectfile.write('\t')
        objectfile.write('-1')
        objectfile.write('\t')
        objectfile.write('0.0')
        objectfile.write('\t')
        objectfile.write('{:d}'.format(int(r[0][0])))
        objectfile.write('\t')
        objectfile.write('{:d}'.format(int(r[0][1])))
        objectfile.write('\t')
        objectfile.write('{:d}'.format(int(r[0][2])))
        objectfile.write('\t')
        objectfile.write('{:d}'.format(int(r[0][3])))
        objectfile.write('\t')
        objectfile.write('0.0')
        objectfile.write('\t')
        objectfile.write('0.0')
